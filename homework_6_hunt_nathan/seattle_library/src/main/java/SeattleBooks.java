...
public class SeattleBooks {
    ...
    public static class MyMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            String title = csvData[6].replaceAll("[^a-zA-Z\\s]","").replaceAll("^\\s*", "");
    ...
    public static class MyReducer
        ...
        public void reduce(Text key, Iterable<IntWritable> values,
            ...
            /* below: version that only counts books if they've been checked
            out more than once. I didn't end up using it because it wasn't 
            clear if it would satisfy the requirements */
            
            // if(result.compareTo(new IntWritable(1)) == 1) {
            //     context.write(key, result);
            // }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println( SeattleBooks.class.getClassLoader().getResource( FILENAME ) );
        String input = SeattleBooks.class.getClassLoader().getResource(FILENAME).getFile();//("").getPath().replaceFirst("^/(.:/)", "$1");
